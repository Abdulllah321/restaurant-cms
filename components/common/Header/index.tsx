...
import { bottomVariants, middleVariants, topVariants, Transition } from '../Sidebar/toggleButtonAnimation';

export default function Header({ onToggle, isCollapsed }: { onToggle: () => void, isCollapsed: boolean }) {
  return (
    <header className="antialiased">
      <nav className="bg-white border-gray-200 px-4 lg:px-6 lg:py-1.5 py-2 dark:bg-gray-800 border-b">
